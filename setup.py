...
setup(
    ...
    url='https://github.com/molssi-seamm/dimer_builder_step',
    ...
    packages=find_packages(include=['dimer_builder_step']),
    ...
    entry_points={
        'org.molssi.seamm': [
            'Dimer Builder = dimer_builder_step:DimerBuilderStep',
        ],
        'org.molssi.seamm.tk': [
            'Dimer Builder = dimer_builder_step:DimerBuilderStep',
        ],
