...
class DimerBuilderStep(object):
    ...
    comments. The felds are as follows:
        ...
        my_description["description"] : tuple
            A description of the Dimer Builder step. It must be
    ...
    def create_node(self, flowchart=None, **kwargs):
        ...
        **kwargs : keyword arguments
        ...
        return dimer_builder_step.DimerBuilder(flowchart=flowchart, **kwargs)
    ...
    def create_tk_node(self, canvas=None, **kwargs):
        ...
        **kwargs : keyword arguments
        ...
        return dimer_builder_step.TkDimerBuilder(canvas=canvas, **kwargs)
    ...
    def description(self):
        ...
        """
        return DimerBuilderStep.my_description
