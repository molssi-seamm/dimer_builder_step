...
Installation
============
The Dimer Builder step is probably already installed in your SEAMM
...
check for `dimer-builder-step`. If it is not installed, or
...
The non-graphical installer is also straightforward::
  ...
  seamm-installer install --update dimer-builder-step
